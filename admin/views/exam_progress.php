...
if(isset($_REQUEST['start'])) {
    ...
    $examStartTime = new DateTime($examInfo->start_time);
    $examEndTime = new DateTime($examInfo->end_time);
                        ...
                        <div class="card-body">
                            <form action="" method="GET" enctype="application/x-www-forms-urlencoded">
                                ...
                                <div class="from-group mt-4 text-center">
                                    ...
                                    <button type="button" class="btn btn-md btn-success continue" name="action" value="begin" onclick="validateOption()">Start Exam &rarr;</button>
                                </div>
                            </form>
                        </div>
                    </div>
...
function validateOption() {
    ...
    let modCode = "<?php echo $_REQUEST['exam']; ?>";
