                        ...
                        <div>
                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="ModCode">
                                        <option value="">Select Module</option>
                                        <?php foreach($modules as $data): 
                                            $selected = ($data->ModCode==$module_code) ? 'selected' : '';
                                        ?>
                                        <option <?php echo $selected; ?> value="<?php echo $data->ModCode; ?>">
                                            <?php echo $data->ModCode.' - '.$data->Description; ?>
                                        </option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    <input type="date" class="form-control" name="DateExam" placeholder="" value="<?php echo $exam_date; ?>">
                                </div>
                                <div class="mb-3">
                                    <input type="time" class="form-control" name="StartTime" placeholder="" value="<?php echo $start_time; ?>">
                                </div>
                                <div class="mb-3">
                                    <input type="time" class="form-control" name="UploadTime" placeholder="" value="<?php echo $end_time; ?>">
                                </div>
                                <div class="mb-3">
